    ...
    public static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private static final String CREATE_PEER_TABLE =
                "create table " + PEERS_TABLE + " ("
                        ...
                        + ")";
        private static final String CREATE_PEER_INDEX =
                String.format("create unique index peer_name_index on %s(%s)",
        ...
        private static final String CREATE_MESSAGE_TABLE =
                "create table " + MESSAGES_TABLE + " ("
                        ...
                        + String.format("foreign key (%s) references %s(%s)",
                                        ...
                                        PeerContract.NAME)
                        + ")";
        private static final String CREATE_MESSAGE_INDEX =
                String.format("create index message_sender_index on %s(%s)",
                        MESSAGES_TABLE, MessageContract.SENDER);

        @Override
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(CREATE_PEER_TABLE);
            db.execSQL(CREATE_PEER_INDEX);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatcher.match(uri)) {
            case MESSAGES_ALL_ROWS:
                ...
                resolver.notifyChange(MessageContract.CONTENT_URI, null);
                return messageUri;
